...
DOMAIN_VALUES = ("personal_kb", "general_chat", "unknown")
QUERY_TYPE_VALUES = (
    "factual",
    "evaluative",
    "causal",
...
Domain = Literal["personal_kb", "general_chat", "unknown"]
QueryType = Literal[
    "factual",
    "evaluative",
    "causal",
...
Retrieval policy:
- For knowledge-style questions about people, concepts, projects, documents, preferences, experiences, or anything that may be in imported notes, set answer_source="personal_kb", need_retrieval=true, kb_required=false, allow_model_fallback=true.
- If the user explicitly asks what the personal knowledge base, notes, docs, imported files, or sources say, set answer_source="personal_kb", need_retrieval=true, kb_required=true, allow_model_fallback=false.
...
- "我的知识库里 ShowMaker 是谁" asks about imported personal knowledge and should retrieve with kb_required=true.
- "我的笔记里打火机是什么" asks about imported personal notes and should retrieve with kb_required=true.
