    ...
    return [
        {
            ...
            "content": (
                ...
                "Do not invent policies, facts, numbers, timelines, URLs, or commitments. "
        ...
        },
        {
            ...
            "content": (
                ...
                "chunk source references next to relevant claims. If not answerable from evidence chunks, say what "
    ...
    return [
        {
            ...
            "content": (
                ...
                "bracketed RAG source references. If the user explicitly asks what their notes, documents, "
...
def _sources(hits: list[RetrievalHit]) -> list[dict[str, Any]]:
    return [
        _source_for_hit(index, hit)
        for index, hit in enumerate(hits[:8], 1)
    ]


def _source_for_hit(rank: int, hit: RetrievalHit) -> dict[str, Any]:
    return {
        "rank": rank,
        "title": hit.title,
